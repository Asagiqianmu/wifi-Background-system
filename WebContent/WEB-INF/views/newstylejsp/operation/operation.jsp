		...
		<div class="content">
			<div class="device_info">
				<div class="dev_se fn_select">
					场所 <span class="chorsesite" id="all">全部</span>
					<ul class="allsite">
						<li>全部</li>
				...
				<div class="info_txt all">
					...
					<p class="all_income">收入：<span id="totalincome">0.00元</span></p>
					</c:if>
				</div>
			</div>
			<div class="various">
			...
			<div class="annular_chart">
				...
				<div class="both">
					<%-- <p class="round" id="reNotRe" style="color:#03A1B9 ! important"> 0%</p>
			...
			<div class="userLineDraw">
				<p>
					起始时间<input type="text" readonly="readonly"
						...
						class="Wdate">
					<button class="ab_btn" id="userGrow">查询</button>
				</p>
			...
			<div class="pay_type">
				...
				<!-- <div id="chartmain" style="width: 800px; height: 300px; margin: 0 auto;"></div> -->
			</div>
				<c:if test="${user.userName != userNamePA}">
			<div class="income">
				<div class="slsq">
					收入统计(元)
					<img class="wh_ts" src="${imgPath}/ts.png">
...
<script type="text/javascript" src="${jsPathv}/echarts.min.js"></script>
<script type="text/javascript" src="${jsPatht}/operation/index.js"></script>
